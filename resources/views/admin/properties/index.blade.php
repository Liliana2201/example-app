    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Список имущества</h3>
                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending">Маркировка</th>
                                        <th>Действия</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach ($properties as $property)
                                        <tr class="odd">
                                            <td class="dtr-control sorting_1">{{ $property->dormitory->title }}</td>
                                            <td class="dtr-control sorting_1">{{ $property->title }}</td>
                                            <td class="dtr-control sorting_1">{{ $property->mark }}</td>
                                            <td>
